class MorphingBlob {
    constructor(containerId, options = {}) {
        ...
        this.options = {
            ...
            color: options.color || new THREE.Color(0.5, 0.8, 1.0),
        ...
        const material = new THREE.ShaderMaterial({
            ...
            vertexShader: `
                ...
                void main() {
                    ...
                    vec3 pos = position;
                    float noise = sin(time * 2.0 + position.y * 4.0) * ${this.options.amplitude};
                    noise += sin(time * 3.0 + position.x * 5.0) * ${this.options.amplitude};
                    pos += normal * noise;
