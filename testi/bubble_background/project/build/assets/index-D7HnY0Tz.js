(function () {
  ...
  var jr = null;
  function cu(e, n, t, r) {
    if (((jr = null), (e = Xu(r)), (e = Sn(e)), e !== null))
  ...
  var vu = typeof setTimeout == "function" ? setTimeout : void 0,
    ...
    Qf =
      typeof queueMicrotask == "function"
        ...
        : typeof fi < "u"
          ? function (e) {
              return fi.resolve(null).then(e).catch(Kf);
            }
          : vu;
  function Kf(e) {
    setTimeout(function () {
    ...
    return (
      ...
      e !== null && !ae
        ? ((n.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~l),
          Ye(e, n, l))
        : (F && t && lo(n), (n.flags |= 1), le(e, n, r, l), n.child)
    );
  }
    ...
    return (
      ...
      e !== null && !ae
        ? ((n.updateQueue = e.updateQueue),
          ...
          (e.lanes &= ~l),
          Ye(e, n, l))
        : (F && r && lo(n), (n.flags |= 1), le(e, n, t, l), n.child)
    );
  }
  function Li(e, n, t, r, l) {
    ...
    if ((Gn(n, l), n.stateNode === null))
      Nr(e, n), Na(n, t, r), xu(n, t, r, l), (r = !0);
    else if (e === null) {
      var o = n.stateNode,
        i = n.memoizedProps;
      o.props = i;
  ...
  function Ua(e) {
    ...
    n !== null && ((e.alternate = null), Ua(n)),
      ...
      e.tag === 5 &&
        ((n = e.stateNode),
        n !== null &&
          (delete n[je], delete n[Vt], delete n[yu], delete n[Yf], delete n[Xf])),
      (e.stateNode = null),
      (e.return = null),
      (e.dependencies = null),
  ...
  function de(e, n) {
    ...
    if (r === 0)
      ...
      if ((t != null && Ko(t), n === 1))
        e.tag === 0 ? Gf(Ui.bind(null, e)) : qs(Ui.bind(null, e)),
          Qf(function () {
            !(R & 6) && hn();
          }),
          (t = null);
  ...
  function Ha(e, n) {
    ...
    if (n !== 0) {
      if (
        ...
        throw ((t = Yt), xn(e, 0), be(e, r), de(e, W()), t);
      if (n === 6) be(e, r);
      else {
        if (
  ...
  function Ui(e) {
    ...
    if (t === 1) throw ((t = Yt), xn(e, 0), be(e, n), de(e, W()), t);
        ...
        return (
          ...
          l.$$typeof === void 0
            ? ((n.tag = 1),
              ...
              xu(n, r, e, t),
              (n = Nu(null, n, r, !0, u, t)))
            : ((n.tag = 0), F && u && lo(n), le(null, n, l, t), (n = n.child)),
          n
        );
      case 16:
        r = n.elementType;
    ...
    switch (e.tag) {
      case 3:
        ...
        if (n.current.memoizedState.isDehydrated) {
          ...
          t !== 0 &&
            (Zu(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), hn()));
        }
        break;
      case 13:
        Ln(function () {
  ...
  ys = _o;
  gs = Ln;
  var Pd = { usingClientEntryPoint: !1, Events: [Jt, Un, ul, hs, vs, _o] },
    vt = {
  ...
  function Ql({
    ...
    const [u, o] = Tt.useState([]);
    return (
      Tt.useEffect(() => {
        o(Td(e, n, t));
      }, [e, n, t]),
      pe.jsx("div", {
        className: `circle-layer ${l}`,
        children: u.map((i, s) =>
          pe.jsx(
            "div",
            {
      ...
      children: [
        ...
        pe.jsx("div", {
          ...
          children: pe.jsxs("div", {
            ...
            children: [
              pe.jsx("h1", {
                className: "text-4xl font-light tracking-widest mb-4",
                children: "FLOATING CIRCLES",
              }),
              pe.jsx("p", {
                className: "text-lg text-gray-300",
                children: "A beautiful animated background",
              }),
            ],
          }),
        }),
  ...
  nc(document.getElementById("root")).render(
    pe.jsx(Tt.StrictMode, { children: pe.jsx(Rd, {}) }),
  );
